...
It is done using either [`skygear.auth.signupWithUsername`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-signupWithUsername) or
[`skygear.auth.signupWithEmail`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-signupWithEmail).
...
you can access the currently logged-in user using [`skygear.auth.currentUser`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-get-currentUser).

[`signupWithUsername`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-signupWithUsername) sample code:
...
[`signupWithEmail`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-signupWithEmail) sample code:
...
by calling [`skygear.auth.signupAnonymously`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-signupAnonymously).
...
Logging out the current user is simple using the [`skygear.auth.logout`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-logout) method.
...
You can retrieve the current user from [`skygear.auth.currentUser`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-get-currentUser).

``` javascript
const user = skygear.auth.currentUser; // if not logged in, it will be null
```

If there is an authenticated user, it will give you a [`User`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/user.js~User.html) object like this:
...
[`currentUser`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-get-currentUser)
...
you can call [`whoami()`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-whoami):
...
register a callback by using the [`skygear.auth.onUserChanged`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-onUserChanged) method.
...
the [`skygear.auth.saveUser`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-saveUser) method by
...
registered through [`skygear.auth.onUserChanged`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-onUserChanged), even if the new username/email is
...
[`username`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/user.js~User.html#instance-member-username) and [`email`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/user.js~User.html#instance-member-email) when calling [`skygear.auth.saveUser`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-saveUser).

## Updating a user's password

The currently logged-in user can change his/her own password.
This can be done using the [`skygear.auth.changePassword`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-changePassword) function.
...
registered through [`skygear.auth.onUserChanged`](https://docs.skygear.io/js/reference/v1.0/class/packages/skygear-core/lib/auth.js~AuthContainer.html#instance-method-onUserChanged).
