...
You can use the [`skygear.loginWithProvider`](https://docs.skygear.io/js/reference/v0/class/packages/skygear-core/lib/container.js~Container.html#instance-method-loginWithProvider) method by providing the name of the
