...
The user profile is created using the record type [`user`](https://docs.skygear.io/js/reference/v0/class/packages/skygear-core/lib/user.js~User.html) with
...
the [`User`](https://docs.skygear.io/js/reference/v0/class/packages/skygear-core/lib/user.js~User.html) record type.
