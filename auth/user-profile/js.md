...
The user profile is created using the record type [`user`](https://doc.esdoc.org/github.com/skygeario/skygear-SDK-JS/class/packages/skygear-core/lib/user.js~User.html) with
...
the [`User`](https://doc.esdoc.org/github.com/skygeario/skygear-SDK-JS/class/packages/skygear-core/lib/user.js~User.html) record type.
